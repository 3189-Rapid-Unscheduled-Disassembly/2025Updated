...
public class FivePlusOne extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //SCORE POSES
        Vector2d scoreVector = new Vector2d(beginPose.position.x+2, 36.5);
        ...
        TrajectoryActionBuilder fromScoreToPush = drive.actionBuilder(scorePose)
                ...
                .splineToLinearHeading(new Pose2d(grabVector.x, grabVector.y, Math.toRadians(90)), Math.toRadians(90),
                        new MinVelConstraint(Arrays.asList(
        ...
        TrajectoryActionBuilder fromGrabToBucket = drive.actionBuilder(grabPose)
                .splineToLinearHeading(new Pose2d(grabVector.x+5, bucketPose.position.y, bucketPose.heading.toDouble()), Math.toRadians(0),
                        new MinVelConstraint(Arrays.asList(
