...
@Autonomous(name = "Blue 5+1")
public class Blue5Plus1 extends LinearOpMode {
    RobotMain bart;
    MecanumDrive drive;
...
*/
        TrajectoryActionBuilder fromGrabToBucket = drive.actionBuilder(AutoPoses.grabWallClipsPose)
                ...
                new ParallelAction(
                        ...
                        new SequentialAction(
                                ...
                                new ParallelAction(
                                        ...
                                        new SequentialAction(
                                                autoActions.waitTillPastX(0, true),
