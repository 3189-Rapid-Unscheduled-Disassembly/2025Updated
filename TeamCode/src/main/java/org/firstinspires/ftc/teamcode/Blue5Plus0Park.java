...
@Autonomous(name = "Blue 5+0 Park")
public class Blue5Plus0Park extends LinearOpMode {
    RobotMain bart;
    MecanumDrive drive;
...
*/
        ...
        TrajectoryActionBuilder fromScoreCycleToPark = drive.actionBuilder(AutoPoses.scoreCycleClipsPose)
                .strafeToConstantHeading(AutoPoses.shiftPoseByInputs(AutoPoses.scoreCycleClipsPose, 0, 6, 0).position,
                        new MinVelConstraint(Arrays.asList(
                                drive.kinematics.new WheelVelConstraint(AutoPoses.scoreCycleGrabMaxWheelVel),
                                new AngularVelConstraint(Math.PI * 1.5)
                        )),
                ...
                .strafeToConstantHeading(AutoPoses.clipsParkPose.position,
                        new MinVelConstraint(Arrays.asList(
                                drive.kinematics.new WheelVelConstraint(AutoPoses.scoreCycleGrabMaxWheelVel),
                                new AngularVelConstraint(Math.PI * 1.5)
                        )),
